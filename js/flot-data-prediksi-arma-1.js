...
$(document).ready(function() {
    ...
    function getHum()
    {
      var xNo = new Array();
      var yTemp = new Array();
      var url = "http://31.220.48.158/projects/iotgateway/raspi02/ms02/apiGetDataJsonMysql_temp.php";
      $.ajax({      
        url: url,
        dataType: 'json',
        cache: false,
        success: function(msg){           
          for(i=0;i<msg.records.length;i++){
            ...
            yTemp[i] = parseInt(msg.records[i].temp);                  
          }
          predictHum(xNo, yTemp);
        }            
      })
  ...
  function predictHum(t, y)
  {
    ...
    document.getElementById('avgData2').innerHTML = "Mean Square Error : <b>" +vErr +"<b>";
