...
$(document).ready(function() {
    ...
    {
      var xNo = new Array();
      var yTekud = new Array();
      var url = "http://31.220.48.158/projects/iotgateway/raspi02/ms05/apiGetDataJsonMongodb_tekud.php";
      $.ajax({      
        url: url,
        dataType: 'json',
        cache: false,
        success: function(msg){           
          for(i=0;i<msg.records.length;i++){
            ...
            yTekud[i] = parseInt(msg.records[i].tekud);                  
          }
          predictHum(xNo, yTekud);
        }            
      })
  ...
  function predictHum(t, y)
  {
    ...
    vErr = nErr.toFixed(2);
    document.getElementById('avgData7').innerHTML = "Rata-Rata : <b>" +yPred +"<b>";
    document.getElementById('avgData8').innerHTML = "Mean Square Error : <b>" +vErr +"<b>";
