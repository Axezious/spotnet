...
$(document).ready(function() {
    ...
    document.getElementById("avgN5").style.display = "none";
    ...
    {
      var xNo = new Array();
      var yKetan = new Array();
      var url = "http://31.220.48.158/projects/iotgateway/raspi02/ms04/apiGetDataJsonMysql_ketan.php";
      $.ajax({      
        url: url,
        dataType: 'json',
        cache: false,
        success: function(msg){           
          for(i=0;i<msg.records.length;i++){
            ...
            yKetan[i] = parseInt(msg.records[i].ketan);                  
          }
          predictHum(xNo, yKetan);
        }            
      })
  ...
  function predictHum(t, y)
  {
    ...
    var plotObj = $.plot($("#flot-line-chart9"), [{
            data: dataOri,
            label: "data Original"
        }, {
            data: dataPredict,
    ...
    var plotObj2 = $.plot($("#flot-line-chart10"), [{
    ...
    vErr = nErr.toFixed(2);
    document.getElementById('avgData9').innerHTML = "Rata-Rata : " +yPred;
    document.getElementById('avgData10').innerHTML = "Mean Square Error : <b>" +vErr +"<b>";
    document.getElementById('avgN5').innerHTML = yPred;
  }  
});