...
$(document).ready(function() {
    ...
    function getHum()
    {
      var xNo = new Array();
      var yHum = new Array();
      var url = "http://31.220.48.158/projects/iotgateway/raspi02/ms02/apiGetDataJsonMysql_hum.php";
      $.ajax({      
        url: url,
        dataType: 'json',
        cache: false,
  ...
  function predictHum(t, y)
  {
    ...
    document.getElementById('avgData').innerHTML = "Rata-Rata Humidity : <b>" +nRata +"<b>";
  }
