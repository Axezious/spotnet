<?php
        ...
        // $doc = ['_id' => new MongoDB\BSON\ObjectID, 'MS' => $ms , 'ldr' => $ldr ,'date' => $date, 'time' => $time , 'status' => 1];
        // $insRec->insert($doc);
        // $writeConcern = new MongoDB\Driver\WriteConcern(MongoDB\Driver\WriteConcern::MAJORITY, 1000);
        // $result = $mng->executeBulkWrite('Raspi01.MS01_ldr', $insRec, $writeConcern);
        // $array = array();
        // $subArray = array();
        ...
        $database = "Raspi02";
          ...
          $sql = "INSERT INTO MS01_ldr(MS,ldr,date,time,status) VALUES ('$ms','$ldr','$date','$time','1')";
          $result = mysqli_query($con, $sql);
          $checkrow = "SELECT MS FROM MS01_ldr WHERE MS = '$ms'";
