<?php
	...
	$time = $_GET["time"];
        ...
        $doc = ['_id' => new MongoDB\BSON\ObjectID, 'MS' => $ms , 'ws' => $ws ,'date' => $date, 'time' => $time , 'status' => 1];
        $insRec->insert($doc);
        $writeConcern = new MongoDB\Driver\WriteConcern(MongoDB\Driver\WriteConcern::MAJORITY, 1000);
        $result = $mng->executeBulkWrite('Raspi02.MS06_ws', $insRec, $writeConcern);
        $array = array();
        $subArray = array();
        ...
        $database = "Raspi02";
          ...
          $sql = "INSERT INTO MS06_ws(MS,ws,date,time,status) VALUES ('$ms','$ws','$date','$time','1')";
          $result = mysqli_query($con, $sql);
          $checkrow = "SELECT MS FROM MS06_ws WHERE MS = '$ms'";
